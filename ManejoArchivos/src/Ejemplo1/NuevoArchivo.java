    ...
    public void agregar_informacion() {
        ...
        while (bandera) // itera hasta que bandera sea false
        {
            try // envía valores al archivo
            {
                ...
                System.out.println("Ingrese la calificaion 1 (debe ser entero)");
                int cal1 = entrada.nextInt(); // lee la calificacion 1 
                System.out.println("Ingrese la calificaion 1 (debe ser entero)");
                int cal2 = entrada.nextInt();// Lee la calificacion 2 
